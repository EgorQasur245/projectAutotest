...
class MainPage(Base):
    ...
    # Locators
    product_1 = "//button[@name='add-to-cart-sauce-labs-backpack']"
    product_2 = "//button[@name='add-to-cart-sauce-labs-bike-light']"
    product_3 = "//button[@name='add-to-cart-sauce-labs-bolt-t-shirt']"
    ...
    def click_add_product_3(self):
        ...
        print("Click add to cart product 3")
    def click_cart(self):
        self.get_cart().click()
        print("Click cart")
    def click_menu(self):
